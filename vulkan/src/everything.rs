...
const MAX_VIDEO_AV1_REFERENCES_PER_FRAME_KHR: u32 = 7;
...
pub enum VideoEncodeH264CapabilityFlagBitsKHR {
	VideoEncodeH264CapabilityHrdComplianceBitKhr = 1 << 0,
	VideoEncodeH264CapabilityPredictionWeightTableGeneratedBitKhr = 1 << 1,
	VideoEncodeH264CapabilityRowUnalignedSliceBitKhr = 1 << 2,
	VideoEncodeH264CapabilityDifferentSliceTypeBitKhr = 1 << 3,
	VideoEncodeH264CapabilityBFrameInL0ListBitKhr = 1 << 4,
	VideoEncodeH264CapabilityBFrameInL1ListBitKhr = 1 << 5,
	VideoEncodeH264CapabilityPerPictureTypeMinMaxQpBitKhr = 1 << 6,
	VideoEncodeH264CapabilityPerSliceConstantQpBitKhr = 1 << 7,
	VideoEncodeH264CapabilityGeneratePrefixNaluBitKhr = 1 << 8,
}

bitflags! {
	#[repr(transparent)]
	pub struct VideoEncodeH264CapabilityFlagsKHR: Flags {
		const VIDEO_ENCODE_H264_CAPABILITY_HRD_COMPLIANCE_BIT_KHR = VideoEncodeH264CapabilityFlagBitsKHR::VideoEncodeH264CapabilityHrdComplianceBitKhr as Flags;
		const VIDEO_ENCODE_H264_CAPABILITY_PREDICTION_WEIGHT_TABLE_GENERATED_BIT_KHR = VideoEncodeH264CapabilityFlagBitsKHR::VideoEncodeH264CapabilityPredictionWeightTableGeneratedBitKhr as Flags;
		const VIDEO_ENCODE_H264_CAPABILITY_ROW_UNALIGNED_SLICE_BIT_KHR = VideoEncodeH264CapabilityFlagBitsKHR::VideoEncodeH264CapabilityRowUnalignedSliceBitKhr as Flags;
		const VIDEO_ENCODE_H264_CAPABILITY_DIFFERENT_SLICE_TYPE_BIT_KHR = VideoEncodeH264CapabilityFlagBitsKHR::VideoEncodeH264CapabilityDifferentSliceTypeBitKhr as Flags;
		const VIDEO_ENCODE_H264_CAPABILITY_B_FRAME_IN_L0_LIST_BIT_KHR = VideoEncodeH264CapabilityFlagBitsKHR::VideoEncodeH264CapabilityBFrameInL0ListBitKhr as Flags;
		const VIDEO_ENCODE_H264_CAPABILITY_B_FRAME_IN_L1_LIST_BIT_KHR = VideoEncodeH264CapabilityFlagBitsKHR::VideoEncodeH264CapabilityBFrameInL1ListBitKhr as Flags;
		const VIDEO_ENCODE_H264_CAPABILITY_PER_PICTURE_TYPE_MIN_MAX_QP_BIT_KHR = VideoEncodeH264CapabilityFlagBitsKHR::VideoEncodeH264CapabilityPerPictureTypeMinMaxQpBitKhr as Flags;
		const VIDEO_ENCODE_H264_CAPABILITY_PER_SLICE_CONSTANT_QP_BIT_KHR = VideoEncodeH264CapabilityFlagBitsKHR::VideoEncodeH264CapabilityPerSliceConstantQpBitKhr as Flags;
		const VIDEO_ENCODE_H264_CAPABILITY_GENERATE_PREFIX_NALU_BIT_KHR = VideoEncodeH264CapabilityFlagBitsKHR::VideoEncodeH264CapabilityGeneratePrefixNaluBitKhr as Flags;
	}
}
...
pub enum VideoEncodeH264StdFlagBitsKHR {
	VideoEncodeH264StdSeparateColorPlaneFlagSetBitKhr = 1 << 0,
	VideoEncodeH264StdQpprimeYZeroTransformBypassFlagSetBitKhr = 1 << 1,
	VideoEncodeH264StdScalingMatrixPresentFlagSetBitKhr = 1 << 2,
	VideoEncodeH264StdChromaQpIndexOffsetBitKhr = 1 << 3,
	VideoEncodeH264StdSecondChromaQpIndexOffsetBitKhr = 1 << 4,
	VideoEncodeH264StdPicInitQpMinus26BitKhr = 1 << 5,
	VideoEncodeH264StdWeightedPredFlagSetBitKhr = 1 << 6,
	VideoEncodeH264StdWeightedBipredIdcExplicitBitKhr = 1 << 7,
	VideoEncodeH264StdWeightedBipredIdcImplicitBitKhr = 1 << 8,
	VideoEncodeH264StdTransform8x8ModeFlagSetBitKhr = 1 << 9,
	VideoEncodeH264StdDirectSpatialMvPredFlagUnsetBitKhr = 1 << 10,
	VideoEncodeH264StdEntropyCodingModeFlagUnsetBitKhr = 1 << 11,
	VideoEncodeH264StdEntropyCodingModeFlagSetBitKhr = 1 << 12,
	VideoEncodeH264StdDirect8x8InferenceFlagUnsetBitKhr = 1 << 13,
	VideoEncodeH264StdConstrainedIntraPredFlagSetBitKhr = 1 << 14,
	VideoEncodeH264StdDeblockingFilterDisabledBitKhr = 1 << 15,
	VideoEncodeH264StdDeblockingFilterEnabledBitKhr = 1 << 16,
	VideoEncodeH264StdDeblockingFilterPartialBitKhr = 1 << 17,
	VideoEncodeH264StdSliceQpDeltaBitKhr = 1 << 19,
	VideoEncodeH264StdDifferentSliceQpDeltaBitKhr = 1 << 20,
}

bitflags! {
	#[repr(transparent)]
	pub struct VideoEncodeH264StdFlagsKHR: Flags {
		const VIDEO_ENCODE_H264_STD_SEPARATE_COLOR_PLANE_FLAG_SET_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdSeparateColorPlaneFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_QPPRIME_Y_ZERO_TRANSFORM_BYPASS_FLAG_SET_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdQpprimeYZeroTransformBypassFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_SCALING_MATRIX_PRESENT_FLAG_SET_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdScalingMatrixPresentFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_CHROMA_QP_INDEX_OFFSET_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdChromaQpIndexOffsetBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_SECOND_CHROMA_QP_INDEX_OFFSET_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdSecondChromaQpIndexOffsetBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_PIC_INIT_QP_MINUS26_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdPicInitQpMinus26BitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_WEIGHTED_PRED_FLAG_SET_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdWeightedPredFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_WEIGHTED_BIPRED_IDC_EXPLICIT_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdWeightedBipredIdcExplicitBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_WEIGHTED_BIPRED_IDC_IMPLICIT_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdWeightedBipredIdcImplicitBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_TRANSFORM_8X8_MODE_FLAG_SET_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdTransform8x8ModeFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_DIRECT_SPATIAL_MV_PRED_FLAG_UNSET_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdDirectSpatialMvPredFlagUnsetBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_ENTROPY_CODING_MODE_FLAG_UNSET_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdEntropyCodingModeFlagUnsetBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_ENTROPY_CODING_MODE_FLAG_SET_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdEntropyCodingModeFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_DIRECT_8X8_INFERENCE_FLAG_UNSET_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdDirect8x8InferenceFlagUnsetBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_CONSTRAINED_INTRA_PRED_FLAG_SET_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdConstrainedIntraPredFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_DEBLOCKING_FILTER_DISABLED_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdDeblockingFilterDisabledBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_DEBLOCKING_FILTER_ENABLED_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdDeblockingFilterEnabledBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_DEBLOCKING_FILTER_PARTIAL_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdDeblockingFilterPartialBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_SLICE_QP_DELTA_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdSliceQpDeltaBitKhr as Flags;
		const VIDEO_ENCODE_H264_STD_DIFFERENT_SLICE_QP_DELTA_BIT_KHR = VideoEncodeH264StdFlagBitsKHR::VideoEncodeH264StdDifferentSliceQpDeltaBitKhr as Flags;
	}
}
...
pub enum VideoEncodeH265CapabilityFlagBitsKHR {
	VideoEncodeH265CapabilityHrdComplianceBitKhr = 1 << 0,
	VideoEncodeH265CapabilityPredictionWeightTableGeneratedBitKhr = 1 << 1,
	VideoEncodeH265CapabilityRowUnalignedSliceSegmentBitKhr = 1 << 2,
	VideoEncodeH265CapabilityDifferentSliceSegmentTypeBitKhr = 1 << 3,
	VideoEncodeH265CapabilityBFrameInL0ListBitKhr = 1 << 4,
	VideoEncodeH265CapabilityBFrameInL1ListBitKhr = 1 << 5,
	VideoEncodeH265CapabilityPerPictureTypeMinMaxQpBitKhr = 1 << 6,
	VideoEncodeH265CapabilityPerSliceSegmentConstantQpBitKhr = 1 << 7,
	VideoEncodeH265CapabilityMultipleTilesPerSliceSegmentBitKhr = 1 << 8,
	VideoEncodeH265CapabilityMultipleSliceSegmentsPerTileBitKhr = 1 << 9,
}

bitflags! {
	#[repr(transparent)]
	pub struct VideoEncodeH265CapabilityFlagsKHR: Flags {
		const VIDEO_ENCODE_H265_CAPABILITY_HRD_COMPLIANCE_BIT_KHR = VideoEncodeH265CapabilityFlagBitsKHR::VideoEncodeH265CapabilityHrdComplianceBitKhr as Flags;
		const VIDEO_ENCODE_H265_CAPABILITY_PREDICTION_WEIGHT_TABLE_GENERATED_BIT_KHR = VideoEncodeH265CapabilityFlagBitsKHR::VideoEncodeH265CapabilityPredictionWeightTableGeneratedBitKhr as Flags;
		const VIDEO_ENCODE_H265_CAPABILITY_ROW_UNALIGNED_SLICE_SEGMENT_BIT_KHR = VideoEncodeH265CapabilityFlagBitsKHR::VideoEncodeH265CapabilityRowUnalignedSliceSegmentBitKhr as Flags;
		const VIDEO_ENCODE_H265_CAPABILITY_DIFFERENT_SLICE_SEGMENT_TYPE_BIT_KHR = VideoEncodeH265CapabilityFlagBitsKHR::VideoEncodeH265CapabilityDifferentSliceSegmentTypeBitKhr as Flags;
		const VIDEO_ENCODE_H265_CAPABILITY_B_FRAME_IN_L0_LIST_BIT_KHR = VideoEncodeH265CapabilityFlagBitsKHR::VideoEncodeH265CapabilityBFrameInL0ListBitKhr as Flags;
		const VIDEO_ENCODE_H265_CAPABILITY_B_FRAME_IN_L1_LIST_BIT_KHR = VideoEncodeH265CapabilityFlagBitsKHR::VideoEncodeH265CapabilityBFrameInL1ListBitKhr as Flags;
		const VIDEO_ENCODE_H265_CAPABILITY_PER_PICTURE_TYPE_MIN_MAX_QP_BIT_KHR = VideoEncodeH265CapabilityFlagBitsKHR::VideoEncodeH265CapabilityPerPictureTypeMinMaxQpBitKhr as Flags;
		const VIDEO_ENCODE_H265_CAPABILITY_PER_SLICE_SEGMENT_CONSTANT_QP_BIT_KHR = VideoEncodeH265CapabilityFlagBitsKHR::VideoEncodeH265CapabilityPerSliceSegmentConstantQpBitKhr as Flags;
		const VIDEO_ENCODE_H265_CAPABILITY_MULTIPLE_TILES_PER_SLICE_SEGMENT_BIT_KHR = VideoEncodeH265CapabilityFlagBitsKHR::VideoEncodeH265CapabilityMultipleTilesPerSliceSegmentBitKhr as Flags;
		const VIDEO_ENCODE_H265_CAPABILITY_MULTIPLE_SLICE_SEGMENTS_PER_TILE_BIT_KHR = VideoEncodeH265CapabilityFlagBitsKHR::VideoEncodeH265CapabilityMultipleSliceSegmentsPerTileBitKhr as Flags;
	}
}
...
pub enum VideoEncodeH265TransformBlockSizeFlagBitsKHR {
	VideoEncodeH265TransformBlockSize4BitKhr = 1 << 0,
	VideoEncodeH265TransformBlockSize8BitKhr = 1 << 1,
	VideoEncodeH265TransformBlockSize16BitKhr = 1 << 2,
	VideoEncodeH265TransformBlockSize32BitKhr = 1 << 3,
}

bitflags! {
	#[repr(transparent)]
	pub struct VideoEncodeH265TransformBlockSizeFlagsKHR: Flags {
		const VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_4_BIT_KHR = VideoEncodeH265TransformBlockSizeFlagBitsKHR::VideoEncodeH265TransformBlockSize4BitKhr as Flags;
		const VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_8_BIT_KHR = VideoEncodeH265TransformBlockSizeFlagBitsKHR::VideoEncodeH265TransformBlockSize8BitKhr as Flags;
		const VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_16_BIT_KHR = VideoEncodeH265TransformBlockSizeFlagBitsKHR::VideoEncodeH265TransformBlockSize16BitKhr as Flags;
		const VIDEO_ENCODE_H265_TRANSFORM_BLOCK_SIZE_32_BIT_KHR = VideoEncodeH265TransformBlockSizeFlagBitsKHR::VideoEncodeH265TransformBlockSize32BitKhr as Flags;
	}
}
...
pub enum VideoEncodeH265RateControlFlagBitsKHR {
	VideoEncodeH265RateControlAttemptHrdComplianceBitKhr = 1 << 0,
	VideoEncodeH265RateControlRegularGopBitKhr = 1 << 1,
	VideoEncodeH265RateControlReferencePatternFlatBitKhr = 1 << 2,
	VideoEncodeH265RateControlReferencePatternDyadicBitKhr = 1 << 3,
	VideoEncodeH265RateControlTemporalSubLayerPatternDyadicBitKhr = 1 << 4,
}

bitflags! {
	#[repr(transparent)]
	pub struct VideoEncodeH265RateControlFlagsKHR: Flags {
		const VIDEO_ENCODE_H265_RATE_CONTROL_ATTEMPT_HRD_COMPLIANCE_BIT_KHR = VideoEncodeH265RateControlFlagBitsKHR::VideoEncodeH265RateControlAttemptHrdComplianceBitKhr as Flags;
		const VIDEO_ENCODE_H265_RATE_CONTROL_REGULAR_GOP_BIT_KHR = VideoEncodeH265RateControlFlagBitsKHR::VideoEncodeH265RateControlRegularGopBitKhr as Flags;
		const VIDEO_ENCODE_H265_RATE_CONTROL_REFERENCE_PATTERN_FLAT_BIT_KHR = VideoEncodeH265RateControlFlagBitsKHR::VideoEncodeH265RateControlReferencePatternFlatBitKhr as Flags;
		const VIDEO_ENCODE_H265_RATE_CONTROL_REFERENCE_PATTERN_DYADIC_BIT_KHR = VideoEncodeH265RateControlFlagBitsKHR::VideoEncodeH265RateControlReferencePatternDyadicBitKhr as Flags;
		const VIDEO_ENCODE_H265_RATE_CONTROL_TEMPORAL_SUB_LAYER_PATTERN_DYADIC_BIT_KHR = VideoEncodeH265RateControlFlagBitsKHR::VideoEncodeH265RateControlTemporalSubLayerPatternDyadicBitKhr as Flags;
	}
}
...
pub enum VideoEncodeH264RateControlFlagBitsKHR {
	VideoEncodeH264RateControlAttemptHrdComplianceBitKhr = 1 << 0,
	VideoEncodeH264RateControlRegularGopBitKhr = 1 << 1,
	VideoEncodeH264RateControlReferencePatternFlatBitKhr = 1 << 2,
	VideoEncodeH264RateControlReferencePatternDyadicBitKhr = 1 << 3,
	VideoEncodeH264RateControlTemporalLayerPatternDyadicBitKhr = 1 << 4,
}

bitflags! {
	#[repr(transparent)]
	pub struct VideoEncodeH264RateControlFlagsKHR: Flags {
		const VIDEO_ENCODE_H264_RATE_CONTROL_ATTEMPT_HRD_COMPLIANCE_BIT_KHR = VideoEncodeH264RateControlFlagBitsKHR::VideoEncodeH264RateControlAttemptHrdComplianceBitKhr as Flags;
		const VIDEO_ENCODE_H264_RATE_CONTROL_REGULAR_GOP_BIT_KHR = VideoEncodeH264RateControlFlagBitsKHR::VideoEncodeH264RateControlRegularGopBitKhr as Flags;
		const VIDEO_ENCODE_H264_RATE_CONTROL_REFERENCE_PATTERN_FLAT_BIT_KHR = VideoEncodeH264RateControlFlagBitsKHR::VideoEncodeH264RateControlReferencePatternFlatBitKhr as Flags;
		const VIDEO_ENCODE_H264_RATE_CONTROL_REFERENCE_PATTERN_DYADIC_BIT_KHR = VideoEncodeH264RateControlFlagBitsKHR::VideoEncodeH264RateControlReferencePatternDyadicBitKhr as Flags;
		const VIDEO_ENCODE_H264_RATE_CONTROL_TEMPORAL_LAYER_PATTERN_DYADIC_BIT_KHR = VideoEncodeH264RateControlFlagBitsKHR::VideoEncodeH264RateControlTemporalLayerPatternDyadicBitKhr as Flags;
	}
}
...
pub enum VideoEncodeH265CtbSizeFlagBitsKHR {
	VideoEncodeH265CtbSize16BitKhr = 1 << 0,
	VideoEncodeH265CtbSize32BitKhr = 1 << 1,
	VideoEncodeH265CtbSize64BitKhr = 1 << 2,
}

bitflags! {
	#[repr(transparent)]
	pub struct VideoEncodeH265CtbSizeFlagsKHR: Flags {
		const VIDEO_ENCODE_H265_CTB_SIZE_16_BIT_KHR = VideoEncodeH265CtbSizeFlagBitsKHR::VideoEncodeH265CtbSize16BitKhr as Flags;
		const VIDEO_ENCODE_H265_CTB_SIZE_32_BIT_KHR = VideoEncodeH265CtbSizeFlagBitsKHR::VideoEncodeH265CtbSize32BitKhr as Flags;
		const VIDEO_ENCODE_H265_CTB_SIZE_64_BIT_KHR = VideoEncodeH265CtbSizeFlagBitsKHR::VideoEncodeH265CtbSize64BitKhr as Flags;
	}
}
...
pub enum VideoEncodeH265StdFlagBitsKHR {
	VideoEncodeH265StdSeparateColorPlaneFlagSetBitKhr = 1 << 0,
	VideoEncodeH265StdSampleAdaptiveOffsetEnabledFlagSetBitKhr = 1 << 1,
	VideoEncodeH265StdScalingListDataPresentFlagSetBitKhr = 1 << 2,
	VideoEncodeH265StdPcmEnabledFlagSetBitKhr = 1 << 3,
	VideoEncodeH265StdSpsTemporalMvpEnabledFlagSetBitKhr = 1 << 4,
	VideoEncodeH265StdInitQpMinus26BitKhr = 1 << 5,
	VideoEncodeH265StdWeightedPredFlagSetBitKhr = 1 << 6,
	VideoEncodeH265StdWeightedBipredFlagSetBitKhr = 1 << 7,
	VideoEncodeH265StdLog2ParallelMergeLevelMinus2BitKhr = 1 << 8,
	VideoEncodeH265StdSignDataHidingEnabledFlagSetBitKhr = 1 << 9,
	VideoEncodeH265StdTransformSkipEnabledFlagSetBitKhr = 1 << 10,
	VideoEncodeH265StdTransformSkipEnabledFlagUnsetBitKhr = 1 << 11,
	VideoEncodeH265StdPpsSliceChromaQpOffsetsPresentFlagSetBitKhr = 1 << 12,
	VideoEncodeH265StdTransquantBypassEnabledFlagSetBitKhr = 1 << 13,
	VideoEncodeH265StdConstrainedIntraPredFlagSetBitKhr = 1 << 14,
	VideoEncodeH265StdEntropyCodingSyncEnabledFlagSetBitKhr = 1 << 15,
	VideoEncodeH265StdDeblockingFilterOverrideEnabledFlagSetBitKhr = 1 << 16,
	VideoEncodeH265StdDependentSliceSegmentsEnabledFlagSetBitKhr = 1 << 17,
	VideoEncodeH265StdDependentSliceSegmentFlagSetBitKhr = 1 << 18,
	VideoEncodeH265StdSliceQpDeltaBitKhr = 1 << 19,
	VideoEncodeH265StdDifferentSliceQpDeltaBitKhr = 1 << 20,
}

bitflags! {
	#[repr(transparent)]
	pub struct VideoEncodeH265StdFlagsKHR: Flags {
		const VIDEO_ENCODE_H265_STD_SEPARATE_COLOR_PLANE_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdSeparateColorPlaneFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_SAMPLE_ADAPTIVE_OFFSET_ENABLED_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdSampleAdaptiveOffsetEnabledFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_SCALING_LIST_DATA_PRESENT_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdScalingListDataPresentFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_PCM_ENABLED_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdPcmEnabledFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_SPS_TEMPORAL_MVP_ENABLED_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdSpsTemporalMvpEnabledFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_INIT_QP_MINUS26_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdInitQpMinus26BitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_WEIGHTED_PRED_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdWeightedPredFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_WEIGHTED_BIPRED_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdWeightedBipredFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_LOG2_PARALLEL_MERGE_LEVEL_MINUS2_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdLog2ParallelMergeLevelMinus2BitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_SIGN_DATA_HIDING_ENABLED_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdSignDataHidingEnabledFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_TRANSFORM_SKIP_ENABLED_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdTransformSkipEnabledFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_TRANSFORM_SKIP_ENABLED_FLAG_UNSET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdTransformSkipEnabledFlagUnsetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_PPS_SLICE_CHROMA_QP_OFFSETS_PRESENT_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdPpsSliceChromaQpOffsetsPresentFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_TRANSQUANT_BYPASS_ENABLED_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdTransquantBypassEnabledFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_CONSTRAINED_INTRA_PRED_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdConstrainedIntraPredFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_ENTROPY_CODING_SYNC_ENABLED_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdEntropyCodingSyncEnabledFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_DEBLOCKING_FILTER_OVERRIDE_ENABLED_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdDeblockingFilterOverrideEnabledFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_DEPENDENT_SLICE_SEGMENTS_ENABLED_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdDependentSliceSegmentsEnabledFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_DEPENDENT_SLICE_SEGMENT_FLAG_SET_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdDependentSliceSegmentFlagSetBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_SLICE_QP_DELTA_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdSliceQpDeltaBitKhr as Flags;
		const VIDEO_ENCODE_H265_STD_DIFFERENT_SLICE_QP_DELTA_BIT_KHR = VideoEncodeH265StdFlagBitsKHR::VideoEncodeH265StdDifferentSliceQpDeltaBitKhr as Flags;
	}
}
...
pub struct VideoEncodeH265SessionParametersCreateInfoKHR {
	...
	max_std_spscount: u32,
	max_std_ppscount: u32,
	p_parameters_add_info: *const VideoEncodeH265SessionParametersAddInfoKHR,
}
...
pub struct VideoEncodeH264SessionParametersCreateInfoKHR {
	...
	max_std_spscount: u32,
	max_std_ppscount: u32,
	p_parameters_add_info: *const VideoEncodeH264SessionParametersAddInfoKHR,
}
